  ...
  return (
    <div className="mobile-container bg-background min-h-screen flex flex-col">
      <div className="flex-1 flex flex-col px-6 py-8 safe-top">
        ...
        <h1 className="heading-lg text-foreground mb-1">Welcome back</h1>
          ...
          {method === 'email' ? (
            <>
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <Input type="email" placeholder="you@example.com" className="pl-10 rounded-xl h-11" value={email} onChange={e => { setEmail(e.target.value); setErrors(p => ({ ...p, email: '' })); }} />
                </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input type="tel" placeholder="+44 7700 000000" className="pl-10 rounded-xl h-11" value={phone} onChange={e => { setPhone(e.target.value); setErrors(p => ({ ...p, phone: '' })); }} />
              </div>
        ...
        <div className="flex gap-3">
          <Button variant="outline" className="flex-1 h-11" type="button" onClick={() => toast.info('Google sign-in coming soon')}>
          ...
          <Button variant="outline" className="flex-1 h-11" type="button" onClick={() => toast.info('Apple sign-in coming soon')}>
