...
const AuthLogin = () => {
  ...
  const handleAppleSignIn = async () => {
    ...
    if (error) toast.error('Apple sign in is coming soon.');
  };
        ...
        >
          <div className="space-y-1.5">
            <div className="relative">
              ...
              <Input
                ...
                className="pl-11 rounded-2xl h-12 bg-muted border-0 text-sm"
                value={email}
          ...
          <div className="space-y-1.5">
            ...
            <div className="text-right">
              <Link to="/auth/forgot" className="text-xs text-primary font-medium">
                Forgot password?
              </Link>
            </div>
          </div>
