    ...
    <div className="mobile-container bg-background min-h-screen flex flex-col">
      <div className="flex-1 flex flex-col px-6 py-8 safe-top">
        ...
        <div className="flex gap-3">
          <Button variant="outline" className="flex-1 h-12 rounded-2xl" type="button" onClick={() => toast.info('Google sign-in coming soon')}>
          ...
          <Button variant="outline" className="flex-1 h-12 rounded-2xl" type="button" onClick={() => toast.info('Apple sign-in coming soon')}>
