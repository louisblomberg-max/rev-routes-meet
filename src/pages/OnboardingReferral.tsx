  ...
  return (
    <div className="mobile-container bg-background min-h-screen flex flex-col">
      ...
      <div className="flex-1 px-6 py-6 overflow-y-auto pb-32">
        <h1 className="text-2xl font-bold text-foreground text-center mb-1">How did you hear{'\n'}about RevNet?</h1>
        <p className="text-sm text-muted-foreground text-center mb-6">This helps us improve our outreach</p>
