  ...
  return (
    <div className="mobile-container bg-background min-h-screen flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-8 text-center">
        ...
        <h1 className="text-2xl font-bold text-foreground mb-3 animate-fade-up">You're all set!</h1>
      ...
      <div className="px-6 pb-10 safe-bottom">
        <Button onClick={handleGo} className="w-full h-14 text-base font-semibold rounded-full gap-2">
          Go to Discovery
