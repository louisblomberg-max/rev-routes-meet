    ...
    <div className="mobile-container bg-background min-h-screen flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-8 text-center">
        <div className="flex justify-center mb-8">
          <img src={revnetLogo} alt="RevNet" className="h-14 w-auto" />
        </div>
        <h1 className="heading-display text-foreground mb-3">Welcome to RevNet</h1>
        <p className="text-muted-foreground text-base leading-relaxed max-w-[300px]">
          Discover meets, routes, services — and your community.
        </p>
      </div>
      ...
      <div className="px-6 pb-8 safe-bottom space-y-3">
        <Button
          onClick={() => navigate('/auth/signup?method=email')}
        ...
        <Button
          variant="outline"
          onClick={() => navigate('/auth/signup?method=phone')}
          className="w-full h-12 text-base font-semibold gap-2"
        >
