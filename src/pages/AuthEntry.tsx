  ...
  return (
    <div className="mobile-container bg-background min-h-screen flex flex-col">
      <div className="flex-1 flex flex-col items-center justify-center px-8 text-center">
        <img src={revnetLogo} alt="RevNet" className="h-14 w-auto mb-10 animate-scale-up" />

        <h1 className="text-3xl font-black text-foreground leading-tight mb-3 tracking-tight">
          Welcome to RevNet
        </h1>
        <p className="text-sm text-muted-foreground max-w-[300px] leading-relaxed">
          Discover events, driving routes, services and communities built for car and motorcycle enthusiasts.
        </p>
      </div>
