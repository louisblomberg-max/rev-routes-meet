  ...
  return (
    <div className="mobile-container bg-background min-h-screen flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-8 text-center">
        <img src={revnetLogo} alt="RevNet" className="h-16 w-auto mb-8 animate-scale-up" />

        <h1 className="text-3xl font-black text-foreground leading-tight mb-3 tracking-tight animate-fade-up">
          Welcome to RevNet
        </h1>
        <p className="text-base text-muted-foreground max-w-[300px] leading-relaxed animate-fade-up">
          Find events, routes, services, clubs — and your people.
        </p>
      </div>
