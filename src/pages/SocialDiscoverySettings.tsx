import { ArrowLeft, MapPin, Users, Car, AlertTriangle, Wrench, Heart, MessageSquare, Route, Plus, ChevronRight, Radio, Clock, Navigation } from 'lucide-react';
...
const SocialDiscoverySettings = () => {
  ...
  return (
    <div className="mobile-container bg-background min-h-screen flex flex-col pb-6">
      {/* Header */}
