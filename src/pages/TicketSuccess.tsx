...
const TicketSuccess = () => {
  ...
  if (!ticket || !event) {
    return (
      <div className="min-h-dvh bg-background flex flex-col items-center justify-center px-6 text-center md:max-w-2xl md:mx-auto">
  ...
  return (
    <div className="min-h-dvh flex flex-col items-center px-6 py-12 md:max-w-2xl md:mx-auto" style={{ backgroundColor: '#ffffff' }}>
      {/* Success header */}
