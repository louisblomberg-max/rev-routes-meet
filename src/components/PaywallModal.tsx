...
const CONFIG: Record<PaywallReason, {
  ...
  service_plan: {
    ...
    perItemPrice: '',
    perItemLabel: '',
    subscribePrice: '£19.99/mo',
    subscribePlan: 'Business',
    benefits: [
      'Service listing on the RevNet map',
      'Featured placement in your area',
      'Customer enquiries and reviews',
  ...
  club_plan: {
    ...
    benefits: [
      ...
      'Club feed, polls and announcements',
      'Member management',
      'Everything else in Enthusiast',
