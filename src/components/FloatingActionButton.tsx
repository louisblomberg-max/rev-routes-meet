  ...
  return (
    <>
      ...
      <button
        ...
        className={`relative w-14 h-14 rounded-full bg-primary shadow-lg shadow-primary/30 flex items-center justify-center transition-all duration-300 hover:shadow-xl hover:shadow-primary/40 active:scale-90 ${isOpen ? 'rotate-45 scale-95' : 'rotate-0'}`}
