    ...
    <div className="h-[calc(100vh-80px)] bg-background flex flex-col overflow-hidden">
        ...
        <div className="bg-card rounded-xl border border-border/50 shadow-card p-3">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <span className="font-semibold text-sm text-foreground">Free Plan</span>
        ...
        <div className="grid grid-cols-3 gap-2">
          {primaryActions.map((action) => {
            ...
            return (
              ...
              >
                <div className={`w-10 h-10 rounded-xl ${action.colorClass} flex items-center justify-center transition-transform group-hover:scale-105`}>
      ...
      <div className="px-4 pt-3 pb-1">
        <div className="bg-card rounded-xl border border-border/50 shadow-card overflow-hidden divide-y divide-border/50">
          <button className="w-full flex items-center gap-3 px-3 py-2.5 hover:bg-muted/50 transition-colors active:bg-muted">
            <div className="w-8 h-8 rounded-lg bg-muted flex items-center justify-center">
              <ShoppingBag className="w-4 h-4 text-muted-foreground" />
            </div>
            <span className="flex-1 text-left font-semibold text-sm text-foreground">RevNet Shop</span>
          ...
          >
            ...
            <span className="flex-1 text-left font-semibold text-sm text-foreground">Settings</span>
            <ChevronRight className="w-4 h-4 text-muted-foreground" />
          </button>
        </div>
      </div>
