  ...
  return (
    <div className="flex-1 flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-8 text-center">
        ...
        <p className="text-sm text-muted-foreground max-w-[300px] leading-relaxed animate-fade-up">
          Discover meets, explore driving routes, connect with enthusiasts and find trusted automotive services.
        </p>
      </div>
