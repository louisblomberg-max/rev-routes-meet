    ...
    <div className="flex-1 flex flex-col">
      ...
      <div className="flex-1 px-6 py-10 flex flex-col items-center">
        ...
        <button
          ...
          className="w-28 h-28 rounded-full bg-card border-2 border-dashed border-border/50 flex items-center justify-center mb-8 relative group transition-all hover:border-primary/50 animate-scale-up"
        >
          {data.avatarUrl ? (
        ...
        <div className="w-full max-w-sm">
          <label className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-2 block">
            Short bio <span className="text-muted-foreground/50">(optional)</span>
          </label>
          <Textarea
