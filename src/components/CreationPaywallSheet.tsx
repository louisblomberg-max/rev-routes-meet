...
const PAYWALL_CONFIG: Record<PaywallType, {
  ...
  service: {
    heading: 'Organiser Plan Required',
    subheading: 'Creating service and business listings requires the Organiser plan',
    icon: Building,
  ...
  club: {
    heading: 'Organiser Plan Required',
    subheading: 'Creating and managing clubs requires the Organiser plan',
    icon: Users,
