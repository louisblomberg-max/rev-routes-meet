...
const PAYWALL_CONFIG: Record<PaywallType, {
  ...
  event: {
    ...
    showPayOnce: true,
    payOnceLabel: 'Pay £2.99 — Publish this event',
    payOncePrice: '£2.99',
    upgradePlan: 'pro',
    upgradePlanLabel: 'Pro Driver',
    monthlyPrice: '£3.99/month',
    yearlyPrice: '£43.99/year',
    yearlySaving: 'Save 8%',
    features: [
  ...
  route: {
    ...
    features: [
      ...
      'Import GPX files',
      'Live location sharing',
      'SOS & breakdown features',
      'Priority visibility',
    ],
  },
  service: {
    heading: 'Pro Driver Plan Required',
    subheading: 'Creating service and business listings requires Pro Driver or higher',
    icon: Building,
  ...
  club: {
    heading: 'Club & Business Plan Required',
    subheading: 'Creating and managing clubs requires the Club & Business plan',
    icon: Users,
    ...
    payOncePrice: '',
    upgradePlan: 'club',
    upgradePlanLabel: 'Club & Business',
    monthlyPrice: '£5.99/month',
    yearlyPrice: '£63.99/year',
    yearlySaving: 'Save 11%',
    features: [
      'Create & manage clubs',
      'Event ticketing with payouts',
      'Business listings on the map',
      'Analytics dashboard',
      'Verified badge',
    ],
