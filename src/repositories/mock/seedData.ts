...
export const seedEvents: RevEvent[] = [
  { id: 'e1', title: 'Porsche Owners Meet', date: 'Sat, Feb 15 • 10:00 AM', location: 'Ace Cafe, London', lat: 51.5407, lng: -0.2206, vehicleTypes: ['Porsche'], vehicleType: 'Porsche Only', eventType: 'Meets', attendees: 47, createdBy: 'user-seed', createdAt: '2024-02-01', visibility: 'public', isMultiDay: false, isRecurring: false },
  { id: 'e2', title: 'JDM Night Drive', date: 'Fri, Feb 21 • 8:00 PM', location: 'Box Hill, Surrey', lat: 51.2569, lng: -0.3117, vehicleTypes: ['JDM'], vehicleType: 'Japanese Cars', eventType: 'Group Drive', attendees: 89, createdBy: 'user-seed', createdAt: '2024-02-01', visibility: 'public', isMultiDay: false, isRecurring: false },
  { id: 'e3', title: 'Classic Car Sunday', date: 'Sun, Feb 23 • 9:00 AM', location: 'Brooklands Museum', lat: 51.3483, lng: -0.4674, vehicleTypes: ['Pre-1990 Classics'], vehicleType: 'Pre-1990 Classics', eventType: 'Show / Exhibition', attendees: 156, createdBy: 'user-seed', createdAt: '2024-02-01', visibility: 'public', isMultiDay: false, isRecurring: false },
  { id: 'e4', title: 'Supercar Breakfast', date: 'Sat, Mar 1 • 8:00 AM', location: 'The Ivy, Chelsea', lat: 51.4907, lng: -0.1661, vehicleTypes: ['Supercars'], vehicleType: 'Supercars Only', eventType: 'Cars & Coffee', attendees: 32, createdBy: 'user-seed', createdAt: '2024-02-01', visibility: 'public', isMultiDay: false, isRecurring: true, recurrenceType: 'monthly' },
  { id: 'e5', title: 'Brands Hatch Track Day', date: 'Sun, Mar 8 • 7:30 AM', location: 'Brands Hatch Circuit', lat: 51.3569, lng: 0.2609, vehicleTypes: ['All Welcome'], vehicleType: 'All Welcome', eventType: 'Track Day', attendees: 64, createdBy: 'user-seed', createdAt: '2024-02-01', visibility: 'public', isMultiDay: false, isRecurring: false, entryFee: '£149', ticketLimit: 80, ticketsSold: 64 },
  { id: 'e6', title: 'Euro Car Meet', date: 'Sat, Mar 15 • 11:00 AM', location: 'Caffeine & Machine', lat: 52.2529, lng: -1.5243, vehicleTypes: ['European'], vehicleType: 'European Cars', eventType: 'Meets', attendees: 120, createdBy: 'user-seed', createdAt: '2024-02-01', visibility: 'public', isMultiDay: false, isRecurring: false },
  { id: 'e7', title: 'Bike Night', date: 'Thu, Mar 20 • 7:00 PM', location: 'Ace Cafe, London', lat: 51.5407, lng: -0.2206, vehicleTypes: ['Motorcycles'], vehicleType: 'Motorcycles Only', eventType: 'Meets', attendees: 78, createdBy: 'user-seed', createdAt: '2024-02-01', visibility: 'public', isMultiDay: false, isRecurring: true, recurrenceType: 'weekly' },
  { id: 'e8', title: 'Cars & Coffee', date: 'Sun, Mar 23 • 9:00 AM', location: 'Goodwood Motor Circuit', lat: 50.8608, lng: -0.7551, vehicleTypes: ['All Welcome'], vehicleType: 'All Welcome', eventType: 'Cars & Coffee', attendees: 245, createdBy: 'user-seed', createdAt: '2024-02-01', visibility: 'public', isMultiDay: true, isRecurring: false, endDate: 'Sun, Mar 23 • 3:00 PM' },
];

export const seedRoutes: RevRoute[] = [
  { id: 'r1', name: 'Coastal Run', distance: '38 miles', type: 'Coastal', vehicleType: 'both', rating: 4.7, createdBy: 'user-seed', createdAt: '2024-01-01', lat: 50.7188, lng: -1.8803, visibility: 'public', elevationGain: 120, scenicRating: 5, trafficLevel: 'low', surfaceType: 'tarmac', difficulty: 'easy', safetyTags: ['Speed cameras'], durationMinutes: 55 },
  { id: 'r2', name: 'Mountain Pass', distance: '52 miles', type: 'Twisty', vehicleType: 'both', rating: 4.8, createdBy: 'user-seed', createdAt: '2024-01-01', lat: 52.9548, lng: -3.8852, visibility: 'public', elevationGain: 890, scenicRating: 4, trafficLevel: 'low', surfaceType: 'tarmac', difficulty: 'challenging', safetyTags: ['Narrow roads', 'Livestock crossing'], durationMinutes: 80 },
  { id: 'r3', name: 'South Downs Scenic', distance: '45 miles', type: 'Scenic', vehicleType: 'both', rating: 4.8, createdBy: 'user-seed', createdAt: '2024-01-01', lat: 50.9000, lng: -0.4500, visibility: 'public', elevationGain: 340, scenicRating: 5, trafficLevel: 'moderate', surfaceType: 'tarmac', difficulty: 'easy', safetyTags: [], durationMinutes: 65 },
  { id: 'r4', name: 'Welsh Dragon Pass', distance: '82 miles', type: 'Twisty', vehicleType: 'car', rating: 4.9, createdBy: 'user-seed', createdAt: '2024-01-01', lat: 52.4153, lng: -3.6847, visibility: 'public', elevationGain: 1200, scenicRating: 5, trafficLevel: 'low', surfaceType: 'mixed', difficulty: 'expert', safetyTags: ['Narrow roads', 'Low car warning', 'Livestock crossing'], durationMinutes: 120 },
  { id: 'r5', name: 'Cotswolds Explorer', distance: '67 miles', type: 'Scenic', vehicleType: 'both', rating: 4.6, createdBy: 'user-seed', createdAt: '2024-01-01', lat: 51.8330, lng: -1.7178, visibility: 'public', elevationGain: 280, scenicRating: 4, trafficLevel: 'moderate', surfaceType: 'tarmac', difficulty: 'easy', safetyTags: [], durationMinutes: 90 },
  { id: 'r6', name: 'Scottish Highlands A82', distance: '120 miles', type: 'Scenic', vehicleType: 'both', rating: 4.9, createdBy: 'user-seed', createdAt: '2024-01-01', lat: 56.8198, lng: -5.1052, visibility: 'public', elevationGain: 650, scenicRating: 5, trafficLevel: 'low', surfaceType: 'tarmac', difficulty: 'moderate', safetyTags: ['Seasonal closure risk', 'Flood risk'], durationMinutes: 180 },
  { id: 'r7', name: 'Peak District Loop', distance: '55 miles', type: 'Mixed', vehicleType: 'bike', rating: 4.7, createdBy: 'user-seed', createdAt: '2024-01-01', lat: 53.3497, lng: -1.7699, visibility: 'public', elevationGain: 520, scenicRating: 4, trafficLevel: 'moderate', surfaceType: 'tarmac', difficulty: 'moderate', safetyTags: ['Speed cameras', 'High traffic'], durationMinutes: 75 },
];

export const seedServices: RevService[] = [
  { id: 's1', name: 'Euro Specialists', category: 'Mechanic', serviceTypes: ['German Cars', 'Diagnostics', 'Servicing'], rating: 4.9, distance: '2.3 miles', reviewCount: 127, openingHours: 'Mon-Fri: 8am - 6pm, Sat: 9am - 2pm', phone: '020 7123 4567', address: '45 Motor Lane, London SW1 2AB', isOpen: true, priceRange: '££', lat: 51.5034, lng: -0.1276, createdBy: 'user-seed', createdAt: '2024-01-01', visibility: 'public', yearsInBusiness: 15, certifications: ['IMI Certified', 'Bosch Service Centre'], servicesOffered: ['Full Service', 'Diagnostics', 'Engine Rebuild'], insuranceVerified: true },
  { id: 's2', name: 'Quick Fit Garage', category: 'Garage', serviceTypes: ['MOT', 'Tyres', 'Brakes', 'Exhausts'], rating: 4.5, distance: '0.8 miles', reviewCount: 89, openingHours: 'Mon-Sat: 8am - 6pm', phone: '020 7234 5678', address: '12 High Street, London E1 4CD', isOpen: true, priceRange: '£', lat: 51.5155, lng: -0.0722, createdBy: 'user-seed', createdAt: '2024-01-01', visibility: 'public', yearsInBusiness: 8, acceptedPaymentMethods: ['Cash', 'Card', 'Bank Transfer'] },
  { id: 's3', name: 'Premium Detailing Co', category: 'Detailing', serviceTypes: ['Full Valet', 'Ceramic Coating', 'PPF', 'Interior'], rating: 4.8, distance: '3.1 miles', reviewCount: 203, openingHours: 'Mon-Sat: 9am - 5pm', phone: '020 7345 6789', address: '78 Shine Road, London NW3 5EF', isOpen: true, priceRange: '£££', lat: 51.5501, lng: -0.1780, createdBy: 'user-seed', createdAt: '2024-01-01', visibility: 'public', serviceMode: 'mobile', mobileRadiusMiles: 15, yearsInBusiness: 6, isVerified: true },
  { id: 's4', name: 'Performance Parts UK', category: 'Parts', serviceTypes: ['Performance', 'OEM', 'Aftermarket', 'Accessories'], rating: 4.7, distance: '5.2 miles', reviewCount: 156, openingHours: 'Mon-Fri: 9am - 5:30pm', phone: '020 7456 7890', address: '23 Speed Way, London SE5 6GH', isOpen: false, priceRange: '££', lat: 51.4735, lng: -0.0919, createdBy: 'user-seed', createdAt: '2024-01-01', visibility: 'public' },
  { id: 's5', name: 'TyrePro Centre', category: 'Tyres', serviceTypes: ['Tyre Fitting', 'Wheel Alignment', 'Balancing', 'Puncture Repair'], rating: 4.6, distance: '1.5 miles', reviewCount: 312, openingHours: 'Mon-Sat: 8am - 7pm, Sun: 10am - 4pm', phone: '020 7567 8901', address: '56 Rubber Road, London W2 7IJ', isOpen: true, priceRange: '£', lat: 51.5154, lng: -0.1755, createdBy: 'user-seed', createdAt: '2024-01-01', visibility: 'public', emergencyCalloutFee: '£45', yearsInBusiness: 12 },
  { id: 's6', name: 'AutoElectric Solutions', category: 'Specialist', serviceTypes: ['Diagnostics', 'Wiring', 'ECU Tuning', 'Audio Install'], rating: 4.9, distance: '4.8 miles', reviewCount: 78, openingHours: 'Mon-Fri: 8:30am - 5:30pm', phone: '020 7678 9012', address: '89 Circuit Lane, London N1 8KL', isOpen: false, priceRange: '££', lat: 51.5362, lng: -0.1033, createdBy: 'user-seed', createdAt: '2024-01-01', visibility: 'public', certifications: ['ASTA Certified'], yearsInBusiness: 10 },
  { id: 's7', name: 'SpeedTune Garage', category: 'Tuning', serviceTypes: ['ECU Remapping', 'Dyno Testing', 'Turbo Upgrades', 'Exhaust Systems'], rating: 4.8, distance: '6.7 miles', reviewCount: 94, openingHours: 'Tue-Sat: 9am - 6pm', phone: '020 7789 0123', address: '34 Power Street, London E14 9MN', isOpen: true, priceRange: '£££', lat: 51.5054, lng: -0.0235, createdBy: 'user-seed', createdAt: '2024-01-01', visibility: 'public', isFeatured: true, yearsInBusiness: 5 },
];
