...
export const seedClubs: Club[] = [
  { id: 'c1', name: 'BMW Enthusiasts UK', tagline: 'For BMW owners & fans', location: 'Nationwide', members: 2340, image: null, description: 'The largest BMW community in the UK.', rules: ['Be respectful', 'No spam', 'Keep discussions on-topic', 'No hate speech'], createdBy: 'user-seed', createdAt: '2023-01-01' },
  { id: 'c2', name: 'Porsche Club GB', tagline: 'Porsche passion since 1961', location: 'London & South East', members: 1856, image: null, description: 'The official Porsche Club Great Britain.', rules: ['Respect fellow members', 'Share experiences', 'Follow event guidelines'], createdBy: 'user-seed', createdAt: '2023-01-01' },
  { id: 'c3', name: 'JDM Legends', tagline: 'Japanese car culture', location: 'Manchester Area', members: 987, image: null, description: 'Celebrating Japanese automotive culture.', rules: ['JDM cars only', 'Be respectful', 'Share your builds'], createdBy: 'user-seed', createdAt: '2023-01-01' },
  { id: 'c4', name: 'Classic Mini Club', tagline: 'Original Mini enthusiasts', location: 'Nationwide', members: 3421, image: null, description: 'For lovers of the original Mini.', rules: ['Classic Minis only', 'Help fellow enthusiasts', 'Share restoration progress'], createdBy: 'user-seed', createdAt: '2023-01-01' },
  { id: 'c5', name: 'Track Day Addicts', tagline: 'Living for the apex', location: 'UK Wide', members: 1245, image: null, description: 'For those who can\'t get enough of circuit driving.', rules: ['Safety first', 'No reckless driving talk', 'Help newcomers'], createdBy: 'user-seed', createdAt: '2023-01-01' },
  { id: 'c6', name: 'Electric Vehicle UK', tagline: 'The future is electric', location: 'Nationwide', members: 4521, image: null, description: 'Everything EV.', rules: ['Be welcoming to EV newcomers', 'No ICE vs EV debates', 'Share charging locations'], createdBy: 'user-seed', createdAt: '2023-01-01' },
];
